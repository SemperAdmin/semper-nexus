...
(function () {
  var ICONS = {
    ...
    'circle-play': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><polygon points="10 8 16 12 10 16 10 8"></polygon></svg>',
  ...
  var LEGACY = {
    'fa-arrows-rotate': 'arrows-rotate', 'fa-circle-play': 'circle-play', 'fa-download': 'download',
